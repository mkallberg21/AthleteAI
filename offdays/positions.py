...
SOCCER: tuple[Position, ...] = (
    _pos("goalkeeper", "Goalkeeper", "soccer", "goalie",
         ...
         mix(soc_keeper_set=6, soc_wall_pass=4, soc_juggle=3,
             gen_lateral_bound=3, gen_pogo=3, gen_squat_jump=3,
             soc_juggle_weak=2, soc_toe_taps=2, gen_push_up=2, gen_lunge=2,
             gen_single_leg_balance=2, gen_side_plank=2, gen_plank=1),
    ...
    _pos("defender", "Defender", "soccer", "defence",
         ...
         mix(soc_shuffle=5, soc_wall_pass=4, soc_juggle=3, soc_juggle_weak=2,
             soc_toe_taps=2, soc_step_over=1, gen_lateral_bound=3, gen_squat=2,
             gen_lunge=2, gen_high_knees=2, gen_glute_bridge=2,
             gen_single_leg_balance=2, gen_plank=1, gen_side_plank=1),
    ...
    _pos("midfielder", "Midfielder", "soccer", "midfield",
         ...
         mix(soc_wall_pass=5, soc_juggle_alt=4, soc_juggle=3, soc_toe_taps=3,
             soc_juggle_weak=3, soc_step_over=2, soc_thigh=2, soc_shuffle=2,
             gen_high_knees=3, gen_burpee=2, gen_lunge=2, gen_glute_bridge=2,
             gen_jump_rope=2, gen_squat=1, gen_plank=1, gen_squat_jump=3),
    ...
    _pos("forward", "Forward", "soccer", "attack",
         ...
         mix(soc_step_over=4, soc_toe_taps=4, soc_juggle_alt=3, soc_juggle=3,
             soc_juggle_weak=3, soc_wall_pass=3, soc_thigh=2,
             gen_squat_jump=3, gen_high_knees=3, gen_lateral_bound=2,
             gen_split_squat=2, gen_lunge=2, gen_glute_bridge=2, gen_squat=1),
