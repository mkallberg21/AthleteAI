...
BASKETBALL: tuple[Position, ...] = (
    _pos("guard", "Guard", "basketball", "perimeter",
         ...
         mix(bkb_dribble=5, bkb_crossover=5, bkb_pound_weak=4, bkb_slide=4,
             bkb_pound_low=3, bkb_stance=2, bkb_between_legs=2, bkb_wall_pass=2,
             gen_lateral_bound=2, gen_high_knees=2, gen_squat_jump=2, gen_lunge=2,
             gen_plank=1),
    ...
    _pos("wing", "Wing", "basketball", "perimeter",
         ...
         mix(bkb_dribble=4, bkb_slide=4, bkb_crossover=3, bkb_pound_weak=3,
             bkb_wall_pass=3, bkb_stance=2, bkb_pound_low=2,
             gen_lateral_bound=2, gen_squat_jump=3, gen_lunge=2, gen_push_up=2,
             gen_tuck_jump=2, gen_squat=1),
    ...
    _pos("post", "Post", "basketball", "frontcourt",
         ...
         mix(bkb_pound_weak=3, bkb_wall_pass=3, bkb_slide=2, bkb_dribble=2,
             bkb_stance=2,
